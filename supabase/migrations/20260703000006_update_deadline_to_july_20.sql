-- Prazo de pedidos alterado de 27/07/2026 para 20/07/2026 às 23:59,
-- para ficar consistente com o texto já exibido na tela de login.
...
begin
  ...
  if now() > timestamptz '2026-07-20 23:59:59-03' then
    raise exception 'O prazo para novos pedidos encerrou em 20/07/2026.';
  end if;
